...
import { Center, Card, Image, CardBody, Container, Tabs, TabList, TabPanels, Tab, TabPanel } from "@chakra-ui/react";
  ...
  return (
    <Tabs>
      ...
      <TabPanels>
        <TabPanel>
          <>
            {authenticated ? (<VcGatedDapp />) : (<Center className="vc-check-page">
              <Container>
                <Card
                  style={{
